                        ...
                        <div class="col-md-8">
                            ...
                            <?= $low["description"]?>
                             ...
                             <label style="font-size: 13px; color: #00cc00;">
                                 <span id="down<?= $low['_id']; ?>"><?= $row13["downloads"]?>
                                </span> downloads</label>
                                    <br>
                            <a href="Resources/Storage/Books/<?php echo $low['book_link'];?>" download class="btn btn-primary btn-xs" onclick="download()">

                                <i class="fa fa-download" aria-hidden="true"></i>
                                Download</a>
                            <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#read_book_<?php echo $low['_id']; ?>">
...
<div class="row">
	...
	<div class="col-lg-12">
		<div class="col-lg-4"><a href="<?php echo $_SERVER['REQUEST_URI'] ?>&post=<?php echo $low3['id']; ?>"><img style="width: 270px;height: 220px" src="<?php echo '/INOGIT/Resources/Storage/Featured_images/'.$low3['featured_image'];?>"></a></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <?= $low["description"]?>
                             ...
                             <?= $low["pages"]?> pages</label> | 
                             <label style="font-size: 13px; color: #00cc00;">
                                 <span id="down<?= $low['_id']; ?>"><?= $low["downloads"]?>
                                </span> downloads</label>
                                    <br>
                            <a href="Resources/Storage/Books/<?php echo $low['book_link'];?>" download class="btn btn-primary btn-xs" onclick="download()">
