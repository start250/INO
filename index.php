...
<?php include($_SERVER['DOCUMENT_ROOT'].'/INOGIT/Public/views/_navs_main.php');?>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <a href="/INOGIT/Public/views/download.php?book_link=<?= $row['book_link']?>" class="btn btn-primary btn-xs">
                                <i class="fa fa-download" aria-hidden="true"></i>
                                Download</a>
                            <a href="/INOGIT/Public/views/show.php?book_link=<?= $row['book_link']?>" class="btn btn-success btn-xs">
                                <i class="fa fa-book" aria-hidden="true"></i>
                                Read Now</a>
                        </div>
                    </div>
